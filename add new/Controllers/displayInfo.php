...
class displayInfo extends Controller
{
    ...
    public function thana(){
        ...
        return view('/display_Thana_rp_info',compact('data_thana'));
    }
    ...
    public function word(){
        ...
        ->select('word_rps.*')
        ->get();
        return view('/display_word_rp_info',compact('data_word'));
    }
    ...
    // dd($array6[0],$array3,$array12,$array9);
        ...
        return view('/display_unit_rp_info',compact('data_unit','data_p','data_d','data_unit2'));
    }
