                               ...
                               <div class="col-sm-4 offset-lg-2">
                                <div class="box">
                                    ...
                                    <div class="details" >
                                        ...
                                        <span class="rp_name" for="name"> {{ $data->rp_name}}</span > <br>
                                            <span class="d_name">{{ $data->d_name}}</span><br><br>
                                        {{-- <span class="d_name" for="name">{{ $data->d_name}}</span><br><br> --}}
                                        {{-- <span class="make_hi" for="name"><strong class="make_hi">স্থান: </strong> {{ $data->PS_name }}</span><br> --}}
                                        <span class="unit" ><strong class="unit_strong stonger">ইউনিট : </strong> {{ $data->union_name}}</span><br>
                                        <span class="email" ><strong class="email_strong stonger">ই-মেইল : </strong> {{ $data->rp_email}}</span><br>
                                        <span class="phone"  ><strong id="phone" class="phone phone_strong stonger">ফোন : </strong> <a id="phone_number" class="phone_num" href="tel:{{ $data->rp_phone}}">{{ $data->rp_phone}}</a> </span><br>
