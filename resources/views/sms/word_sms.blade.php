    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="title_page"> ওয়ার্ডের দায়িত্বভার ব্যক্তিরদের বার্তা পাঠান </h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> ওয়ার্ডের দায়িত্বভার ব্যক্তিরদের বার্তা পাঠান </li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="table-responsive">
                        <table id="datatable" class="table table-hover table-bordered">
                            ...
                            <tbody>
                            @foreach($word_details as $key=>$wd)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$wd->name.'-'.$wd->no}}</td>
                                    <td>{{$wd->PS_name}}</td>
