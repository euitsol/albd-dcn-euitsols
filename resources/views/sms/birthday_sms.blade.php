    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="title_page"> জন্মদিনের শুভেচ্ছা পাঠান </h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> জন্মদিনের শুভেচ্ছা পাঠান </li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <table id="datatable" class="table table-hover table-bordered">
                            ...
                            @forelse($data as $dt)
                                <tr>
                                    ...
                                    <td>{{$dt['name']}}</td>
                                    <td>{{$dt['phone']}}</td>
                                    <td>{{date('d-m-Y', strtotime($dt['birthdate']))}}</td>
                                    <td>{{$dt['designation']}}</td>
                                    <td>
                                        <label class="check_box_container">
                                            <input type="checkbox" name="number[]" value="{{ $dt['phone'] }}" checked="checked">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6">আজকে কারো জন্মদিন পাওয়া যায় নি</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
