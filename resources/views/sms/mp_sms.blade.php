    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="title_page">এম.পি দের বার্তা পাঠান </h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">এম.পি দের বার্তা পাঠান </li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <table id="datatable" class="table table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-top-0 text-center">নির্বাচন করুন</th>
                                </tr>
                            </thead>
                            <tbody>
                            @foreach($mp_details as $key=>$md)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$md->parlament_seat->name.'-'.$md->parlament_seat->no}}</td>
                                    <td >{{$md->mp_name}}</td>
                                    <td >{{$md->mp_phone}}</td>
                                    <td >{{$md->mp_email}}</td>
                                    <td>
